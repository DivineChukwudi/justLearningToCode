...
public class VehicleScreen extends JFrame {

    DefaultTableModel model = new DefaultTableModel();
    JTable table;
    JTextField fReg, fType, fCap, fDate, fDepot, mVid, mDate, mType, mCost;
    ...
    public VehicleScreen() {
        ...
        fReg = UIHelper.field(16, "TR-001"); fType = UIHelper.field(16, "e.g., Box Truck"); fCap = UIHelper.field(16, "5000");
        fDate = UIHelper.field(16, "2026-01-15"); fDepot = UIHelper.field(16, "Depot ID");
        ...
        UIHelper.row(addCard, "Depot ID",         fDepot);
        ...
        mVid = UIHelper.field(16, "Vehicle ID"); mDate = UIHelper.field(16, "2026-03-25");
        mType = UIHelper.field(16, "e.g., Oil Change"); mCost = UIHelper.field(16, "500");
        ...
        add(UIHelper.bottomBar(this, btnBack, btnLoad, btnDel, btnMV, btnRefresh), BorderLayout.SOUTH);
        ...
        btnAdd.addActionListener(e -> {
            try {
                ...
                ps.setInt(5, Integer.parseInt(fDepot.getText().trim()));
        ...
        btnM.addActionListener(e -> {
            try {
                DBConnection.callProc("{CALL record_vehicle_maintenance(?,?,?,?)}",
                    Integer.parseInt(mVid.getText().trim()),
                    mDate.getText().trim(),
                    mType.getText().trim(),
        ...
        btnDel.addActionListener(e -> {
            ...
            if (JOptionPane.showConfirmDialog(this, "Delete vehicle #" + id + "?", "Confirm",
