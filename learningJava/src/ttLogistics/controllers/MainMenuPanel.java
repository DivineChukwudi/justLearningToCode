        ...
        for (int i = 0; i < tiles.length; i++) {
            ...
            tile.addMouseListener(new MouseAdapter() {
                public void mouseClicked(MouseEvent e) {
                    switch (idx) {
                        case 0 -> appFrame.switchToVehicles();
                        case 1 -> appFrame.switchToDrivers();
                        case 2 -> appFrame.switchToTrips();
                        case 3 -> appFrame.switchToReports();
                        case 4 -> appFrame.switchToClients();
                        case 5 -> appFrame.logout();
                    }
                }
